function ServiceItem({serviceName, imgSrc}: {serviceName: string, imgSrc: string}){
    return(
        <div className="flex flex-col items-center">
            ...
            <img src={imgSrc} alt={imgSrc} className="aspect-square object-cover rounded-xl border-[5px] border-[var(--neutral-green)] drop-shadow-md"></img>
        </div>
    )
}
    ...
    return(
        <>
            <div id="services" className="w-full flex flex-col items-center">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-8 rounded-xl drop-shadow-2xl bg-[var(--light-pink)] px-8 pb-8 pt-4">
