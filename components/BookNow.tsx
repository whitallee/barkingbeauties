    ...
    return (
        <motion.section whileInView="animate" viewport={{once:true,}} custom={0} variants={fadeInAnimationVariants} initial="initial" animate="animate" className="flex justify-center items-center py-8">
            ...
            <div className="text-4xl bg-white p-4 rounded-lg button-glow hover:scale-105 flex flex-col gap-2 items-center justify-center text-center overflow-hidden">
              <h3>Book Now</h3>
              <Link className="p-2 rounded-lg bg-[#351D48] text-white text-sm sm:text-2xl w-full text-nowrap" href={"tel:7372395747"}>By Phone: 737-239-5747</Link>
              <Link className="p-2 rounded-lg bg-[#351D48] text-white text-sm sm:text-2xl w-full text-nowrap" href={"mailto:barkingbeautiesps@gmail.com"}>By Email: barkingbeautiesps@gmail.com</Link>
            </div>
        </motion.section>
    )
}