export default function Boutique(){
    return(
        <>
            <div id="boutique" className="w-full flex flex-col items-center">
                <h2 className="text-4xl pb-8 text-center">Coming Soon: Barking Beauties Pet Boutique!</h2>
                <p className="px-4">
                    Get ready to pamper your pets like never before! Barking Beauties Pet Salon is excited to announce our upcoming Pet Boutique, a haven for pet lovers and their furry friends.
                    <br/><br/>
                    <h3 className="font-bold text-2xl py-4">What to Expect:</h3>
