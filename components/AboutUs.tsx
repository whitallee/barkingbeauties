        ...
        <>
            <div id="about-us" className="w-full flex flex-col items-center">
                ...
                <div className="flex flex-col pb-8">
                    <img alt="Addie" src="/aboutus_addie.png" className="w-40 min-[500px]:w-60 sm:w-80 relative -translate-x-[25%] scale-110 rounded-xl border-[5px] border-[var(--light-blue)] shadow-md shaddow-inner"></img>
                    <img alt="Haley and Lisa" src="/aboutus_haley_lisa.png" className="w-40 min-[500px]:w-60 sm:w-80 relative translate-x-[25%] scale-110 rounded-xl border-[5px] border-[var(--light-blue)] shadow-md shaddow-inner"></img>
                    <img alt="Lisa and Katiya" src="/aboutus_lisa_katiya.png" className="w-40 min-[500px]:w-60 sm:w-80 relative -translate-x-[25%] scale-110 rounded-xl border-[5px] border-[var(--light-blue)] shadow-md shaddow-inner"></img>
                </div>
                <p className="p-4">
                    Welcome to Barking Beauties Pet Salon! Founded by lifelong friends and dedicated pet lovers, Lisa and Haley, our salon is a dream come true. Lisa&apos;s cat, Katiya, and Haley&apos;s dog, Addie, have been our constant companions and inspiration on this journey.<br/><br/>
