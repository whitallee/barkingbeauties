...
export default function Navbar() {
    return(
        <div id="navbar" className="flex justify-between sticky top-0 w-svw px-6 sm:px-16 bg-gradient-to-b from-[var(--light-blue)] from-10% via-[rgba(200,231,252,0.6)] via-70% to-transparent backdrop-blur-[2px] z-[10000]">
            <a href="/" className="hover:scale-125 transition-all rounded-xl my-3 bg-white"><Image alt="Barking Beauties logo" src="/BBPS_logo_2.PNG" fetchPriority="high" width={160} height={128} className="min-w-24 max-w-40 w-24 sm:w-40" /></a>
