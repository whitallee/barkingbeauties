...
export default function Navbar() {
    return(
        <div id="navbar" className="flex justify-between items-center sticky top-0 w-svw px-6 sm:px-16 bg-gradient-to-b from-[var(--light-blue)] from-10% via-[rgba(200,231,252,0.6)] via-70% to-transparent backdrop-blur-[2px] z-[10000]">
            {/* min-w-24 max-w-40 w-24 sm:w-40 */}
            <a href="/" className="hover:scale-125 transition-all rounded-xl" style={{background:"radial-gradient(white 0%, transparent 70%)"}}><Image alt="Barking Beauties logo" src="/BBPSFavicon.png" fetchPriority="high" width={160} height={128} className="w-14 sm:w-16 py-4" /></a> 
